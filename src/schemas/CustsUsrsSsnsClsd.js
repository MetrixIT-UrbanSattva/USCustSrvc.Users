...
// --- Begin: Customers Users Sessions Closed Schema --- //
...
}, {collection: config.collCustsUsrSsnsClsd});

schema.index({delFlag: 1, uHoda: 1});

module.exports = mongoose.model(config.collCustsUsrsSsnsClsd, schema);
// --- End: Customers Users Sessions Closed Schema --- //
